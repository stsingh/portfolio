...
const ProjectCard = ({staticImage, title, url, gturl, description, tools}: props) => {
    ...
    return (
        <a href={url} target='_blank'>
            <div className="relative col-span-1 flex h-full flex-col bg-gray rounded border-2 p-2">
                {staticImage()}
                ...
                <a href={gturl} target='_blank' className='bottom-2 right-2 absolute'>
                    <button className="inline-block flex text-black fill-black hover:text-flame fill-gray hover:fill-flame">
