...
const Footer = () => {
    return (
        <footer className="bg-black bottom-0 w-full mt-auto">
            <div className="mx-auto max-w-screen-xl p-4 md:flex md:items-center md:justify-between">
                <span className="text-sm text-white sm:text-center">
                    © 2023 Sahej Singh. All Rights Reserved.
                </span>
                <div className="flex items-center space-x-6 md:px-6 pt-4 pb-2 text-gray">
